...
public class WebTTs {
	...
	private static final String API_KEY = "48af6521954bf2b8120676a78991027c";
	// 待合成文本
	private static final String TEXT = "我今天请假，明天去本溪";
	...
	public static void main(String[] args) throws IOException {
		...
		if ("audio/mpeg".equals(resultMap.get("Content-Type"))) { // 合成成功
			if ("raw".equals(AUE)) {
				FileUtil.save("/Users/cuixiaom/Downloads/", resultMap.get("sid") + ".wav", (byte[]) resultMap.get("body"));
				System.out.println("合成 WebAPI 调用成功，音频保存位置：resource\\" + resultMap.get("sid") + ".wav");
			} else {
				FileUtil.save("/Users/cuixiaom/Downloads/", resultMap.get("sid") + ".mp3", (byte[]) resultMap.get("body"));
