...
public class WebIAT {
	...
	private static final String API_KEY = "3c36e8044c2ab0fc9ebbd8c6e20d8917";
	// 音频编码
	...
	private static final String AUDIO_PATH = "/Users/cuixiaom/Downloads/hts0030d371@ch4618102d9b82477400.wav";
	public String audioId(String audio) throws UnsupportedEncodingException {
		Map<String, String> header = buildHttpHeader();		
		return HttpUtil.doPost1(WEBIAT_URL, header, "audio=" + URLEncoder.encode(audio, "UTF-8"));
	}
